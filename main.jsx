...
export default function DietPlanner() {
  ...
  const generate = () => {
    ...
    setResult({ bmr, tdee, sportKcalPerDay, targets, weekPlan, costs, bodyFatPercent, leanMass, hydration, workoutTips });
    setStep(2);
  };
...
function ResultView({ result, budget, onBack }) {
  const { bmr, tdee, targets, costs, bodyFatPercent, leanMass, hydration, workoutTips } = result;
    ...
    <div style={{ display: "grid", gap: 22 }}>
      ...
      <div className="card">
        ...
        <div className="sans" style={{ marginTop: 10, fontSize: 12, color: "#9A937F" }}>
          Nota: prezzi medi indicativi, non in tempo reale. In una versione reale, qui comparirebbero i punti vendita più vicini per fascia, tramite geolocalizzazione.
        </div>
      </div>
